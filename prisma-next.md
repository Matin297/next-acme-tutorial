...
Your data contract is the heart of your application. It lives at [`lib/prisma/contract.prisma`](lib/prisma/contract.prisma) and describes your models:
...
export default definePrismaConfig({
  orm: ormConfig({
    contract: './lib/prisma/contract.prisma',
    db: {
...
| File | Purpose |
|---|---|
| [`lib/prisma/contract.prisma`](lib/prisma/contract.prisma) | Your data contract — define your models here |
| [`prisma.config.ts`](prisma.config.ts) | CLI configuration |
| [`lib/prisma/db.ts`](lib/prisma/db.ts) | Database client — `import { db } from './lib/prisma/db'` |
| `lib/prisma/contract.json` | Compiled contract (generated) |
| `lib/prisma/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`lib/prisma/contract.prisma`](lib/prisma/contract.prisma) to add or change models.
